...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    const handleFocus = () => {
      console.log("[Admin] Window focused, syncing data...");
      fetchData();
      syncAllPendingPayments();
    };
  ...
  }, [token, fetchData, syncAllPendingPayments]);
              ...
              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 w-full xl:w-auto overflow-hidden">
                ...
                {subTabConfig.map(t => (
                  <button
                    ...
                    className={cn(
                      'flex items-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 whitespace-nowrap shrink-0',
    ...
    return (
      <div className="space-y-6 animate-in fade-in duration-500">
        <div className="bg-white rounded-3xl border-2 border-slate-300 shadow-xl overflow-hidden mt-6">
          <div className="p-6 border-b-2 border-slate-200 bg-blue-50/50 space-y-4">
            <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4">
              <div>
