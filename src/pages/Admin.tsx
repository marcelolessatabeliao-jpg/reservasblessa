              ...
              <div className="p-6 border-b border-emerald-100 bg-emerald-50/50">
                ...
                <div className="p-4 bg-white">
                  <Calendar
                    ...
                    classNames={{
                      month: "space-y-6",
                      caption: "relative flex items-center justify-center h-14 bg-emerald-800 rounded-2xl border-2 border-emerald-900 shadow-xl mb-4",
                      caption_label: "text-[12px] font-black text-white uppercase tracking-[0.25em] text-center px-8",
                      nav: "absolute inset-0 flex items-center justify-between px-3 pointer-events-none z-30",
                      nav_button: "h-9 w-9 bg-emerald-500 text-white border border-emerald-400 hover:bg-emerald-400 shadow-lg rounded-[0.6rem] transition-all pointer-events-auto flex items-center justify-center",
